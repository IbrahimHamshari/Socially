...
using Socially.SocialGroup.Core.ProjectAggregate;
using Socially.SocialGroup.Core.Services;
using Socially.SocialGroup.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Socially.SocialGroup.UnitTests.Core.Services
{
