...
To update the database use this command from the Web project folder (replace `Socially.ContentManagment` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Socially.ContentManagment.Infrastructure/Socially.ContentManagment.Infrastructure.csproj -s Socially.ContentManagment.Web.csproj
```
